...
# predict model file
USE_DATASET_NAME = ["RWC_Popular_Dataset", "CCM_Dataset", "Huawei_Dataset"][0]
USE_MODEL_DIC = {
    algo: f"{SA_HOME}/data/models/{USE_DATASET_NAME}_{algo}_TRAIN.pkl"
    for algo in [
        "scluster",
        "cnmf",
        "sf",
...
USE_MODEL_DIC[
    "seqRecur"
] = f"{SA_HOME}/data/models/{USE_DATASET_NAME}_tf{SSM_TRANSFORM_IDENTIFIER}_seqRecur_TRAIN.pkl"
